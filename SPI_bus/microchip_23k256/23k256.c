...
static rtems_status_code spi_23k256_write(
...
static rtems_status_code spi_23k256_read(
  rtems_device_major_number major,
  rtems_device_minor_number minor,
  void *arg
) {
...
static rtems_driver_address_table spi_23k256_rw_ops = {
  .read_entry = spi_23k256_read,
  .write_entry = spi_23k256_write
};

static rtems_libi2c_drv_t spi_23k256_rw_drv_t = {
  .ops = &spi_23k256_rw_ops,
  .size = sizeof(spi_23k256_rw_drv_t)
};

int spi_libi2c_register_23k256(unsigned spi_bus)
{
